...
test("scripts/redis-doc/commands/sdiff.md example 1", async t => {
    const overrider = getOverride("scripts/redis-doc/commands/sdiff.md");
    let snapshot: any;
    const commands = [
    ...
    try {
        ...
        output.push(await handy.sdiff("key1", "key2"));
