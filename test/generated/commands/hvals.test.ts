...
test("scripts/redis-doc/commands/hvals.md example 1", async t => {
    const overrider = getOverride("scripts/redis-doc/commands/hvals.md");
    let snapshot: any;
    const commands = [
    ...
    try {
        ...
        output.push(await handy.hvals("myhash"));
