...
test("docs/redis-doc/commands/zrange.md example 3", async () => {
    ...
    // decoding ZRANGE overload 0 (key,min,max): { name: 'key', schema: { title: 'key', type: 'string' }, toString: [Function (anonymous)] },{ name: 'min', schema: { title: 'min', type: 'string' }, toString: [Function (anonymous)] },{ name: 'max', schema: { title: 'max', type: 'string' }, toString: [Function (anonymous)] }
    ...
    // ---
    // decoding ZRANGE overload 1 (key,min,max,withscores): { name: 'key', schema: { title: 'key', type: 'string' }, toString: [Function (anonymous)] },{ name: 'min', schema: { title: 'min', type: 'string' }, toString: [Function (anonymous)] },{ name: 'max', schema: { title: 'max', type: 'string' }, toString: [Function (anonymous)] },{ name: 'withscores', optional: true, schema: { title: 'withscores', type: 'string', enum: [ 'WITHSCORES' ] }, toString: [Function (anonymous)] }
    ...
    // ---
    // decoding ZRANGE overload 2 (key,min,max,LIMIT): { name: 'key', schema: { title: 'key', type: 'string' }, toString: [Function (anonymous)] },{ name: 'min', schema: { title: 'min', type: 'string' }, toString: [Function (anonymous)] },{ name: 'max', schema: { title: 'max', type: 'string' }, toString: [Function (anonymous)] },{ name: 'LIMIT', optional: true, schema: { title: 'LIMIT', type: 'array', items: [ { type: 'string', const: 'LIMIT' }, { title: 'offset, count', type: 'array', items: [ { title: 'offset', type: 'integer' }, { title: 'count', type: 'integer' } ] } ] }, toString: [Function (anonymous)] }
    // myzset successfully decoded as key (string). Decoded value myzset. Tokens remaining [(1,+inf,BYSCORE,LIMIT,1,1], target args remainin count: 3
    // (1 successfully decoded as min (string). Decoded value (1. Tokens remaining [+inf,BYSCORE,LIMIT,1,1], target args remainin count: 2
    // +inf successfully decoded as max (string). Decoded value +inf. Tokens remaining [BYSCORE,LIMIT,1,1], target args remainin count: 1
    ...
    // Expected LIMIT, got BYSCORE
    // ---
    // decoding ZRANGE overload 4 (key,min,max,rev): { name: 'key', schema: { title: 'key', type: 'string' }, toString: [Function (anonymous)] },{ name: 'min', schema: { title: 'min', type: 'string' }, toString: [Function (anonymous)] },{ name: 'max', schema: { title: 'max', type: 'string' }, toString: [Function (anonymous)] },{ name: 'rev', optional: true, schema: { title: 'rev', type: 'string', enum: [ 'REV' ] }, toString: [Function (anonymous)] }
    // myzset successfully decoded as key (string). Decoded value myzset. Tokens remaining [(1,+inf,BYSCORE,LIMIT,1,1], target args remainin count: 3
    // (1 successfully decoded as min (string). Decoded value (1. Tokens remaining [+inf,BYSCORE,LIMIT,1,1], target args remainin count: 2
    // +inf successfully decoded as max (string). Decoded value +inf. Tokens remaining [BYSCORE,LIMIT,1,1], target args remainin count: 1
    // Expected one of REV, got BYSCORE
    // ---
    // decoding ZRANGE overload 5 (key,min,max,rev,withscores): { name: 'key', schema: { title: 'key', type: 'string' }, toString: [Function (anonymous)] },{ name: 'min', schema: { title: 'min', type: 'string' }, toString: [Function (anonymous)] },{ name: 'max', schema: { title: 'max', type: 'string' }, toString: [Function (anonymous)] },{ name: 'rev', optional: true, schema: { title: 'rev', type: 'string', enum: [ 'REV' ] }, toString: [Function (anonymous)] },{ name: 'withscores', optional: true, schema: { title: 'withscores', type: 'string', enum: [ 'WITHSCORES' ] }, toString: [Function (anonymous)] }
    // myzset successfully decoded as key (string). Decoded value myzset. Tokens remaining [(1,+inf,BYSCORE,LIMIT,1,1], target args remainin count: 4
    // (1 successfully decoded as min (string). Decoded value (1. Tokens remaining [+inf,BYSCORE,LIMIT,1,1], target args remainin count: 3
    // +inf successfully decoded as max (string). Decoded value +inf. Tokens remaining [BYSCORE,LIMIT,1,1], target args remainin count: 2
    // Expected one of REV, got BYSCORE
    // ---
    // decoding ZRANGE overload 6 (key,min,max,rev,LIMIT): { name: 'key', schema: { title: 'key', type: 'string' }, toString: [Function (anonymous)] },{ name: 'min', schema: { title: 'min', type: 'string' }, toString: [Function (anonymous)] },{ name: 'max', schema: { title: 'max', type: 'string' }, toString: [Function (anonymous)] },{ name: 'rev', optional: true, schema: { title: 'rev', type: 'string', enum: [ 'REV' ] }, toString: [Function (anonymous)] },{ name: 'LIMIT', optional: true, schema: { title: 'LIMIT', type: 'array', items: [ { type: 'string', const: 'LIMIT' }, { title: 'offset, count', type: 'array', items: [ { title: 'offset', type: 'integer' }, { title: 'count', type: 'integer' } ] } ] }, toString: [Function (anonymous)] }
    // myzset successfully decoded as key (string). Decoded value myzset. Tokens remaining [(1,+inf,BYSCORE,LIMIT,1,1], target args remainin count: 4
    // (1 successfully decoded as min (string). Decoded value (1. Tokens remaining [+inf,BYSCORE,LIMIT,1,1], target args remainin count: 3
    // +inf successfully decoded as max (string). Decoded value +inf. Tokens remaining [BYSCORE,LIMIT,1,1], target args remainin count: 2
    // Expected one of REV, got BYSCORE
    ...
    // Expected one of REV, got BYSCORE
    // ---
    // decoding ZRANGE overload 8 (key,min,max,sortby): { name: 'key', schema: { title: 'key', type: 'string' }, toString: [Function (anonymous)] },{ name: 'min', schema: { title: 'min', type: 'string' }, toString: [Function (anonymous)] },{ name: 'max', schema: { title: 'max', type: 'string' }, toString: [Function (anonymous)] },{ name: 'sortby', optional: true, schema: { title: 'sortby', type: 'string', enum: [ 'BYSCORE', 'BYLEX' ] }, toString: [Function (anonymous)] }
    // myzset successfully decoded as key (string). Decoded value myzset. Tokens remaining [(1,+inf,BYSCORE,LIMIT,1,1], target args remainin count: 3
    // (1 successfully decoded as min (string). Decoded value (1. Tokens remaining [+inf,BYSCORE,LIMIT,1,1], target args remainin count: 2
    // +inf successfully decoded as max (string). Decoded value +inf. Tokens remaining [BYSCORE,LIMIT,1,1], target args remainin count: 1
    ...
    // ---
    // decoding ZRANGE overload 9 (key,min,max,sortby,withscores): { name: 'key', schema: { title: 'key', type: 'string' }, toString: [Function (anonymous)] },{ name: 'min', schema: { title: 'min', type: 'string' }, toString: [Function (anonymous)] },{ name: 'max', schema: { title: 'max', type: 'string' }, toString: [Function (anonymous)] },{ name: 'sortby', optional: true, schema: { title: 'sortby', type: 'string', enum: [ 'BYSCORE', 'BYLEX' ] }, toString: [Function (anonymous)] },{ name: 'withscores', optional: true, schema: { title: 'withscores', type: 'string', enum: [ 'WITHSCORES' ] }, toString: [Function (anonymous)] }
    // myzset successfully decoded as key (string). Decoded value myzset. Tokens remaining [(1,+inf,BYSCORE,LIMIT,1,1], target args remainin count: 4
    // (1 successfully decoded as min (string). Decoded value (1. Tokens remaining [+inf,BYSCORE,LIMIT,1,1], target args remainin count: 3
    // +inf successfully decoded as max (string). Decoded value +inf. Tokens remaining [BYSCORE,LIMIT,1,1], target args remainin count: 2
    ...
    // ---
    // decoding ZRANGE overload 10 (key,min,max,sortby,LIMIT): { name: 'key', schema: { title: 'key', type: 'string' }, toString: [Function (anonymous)] },{ name: 'min', schema: { title: 'min', type: 'string' }, toString: [Function (anonymous)] },{ name: 'max', schema: { title: 'max', type: 'string' }, toString: [Function (anonymous)] },{ name: 'sortby', optional: true, schema: { title: 'sortby', type: 'string', enum: [ 'BYSCORE', 'BYLEX' ] }, toString: [Function (anonymous)] },{ name: 'LIMIT', optional: true, schema: { title: 'LIMIT', type: 'array', items: [ { type: 'string', const: 'LIMIT' }, { title: 'offset, count', type: 'array', items: [ { title: 'offset', type: 'integer' }, { title: 'count', type: 'integer' } ] } ] }, toString: [Function (anonymous)] }
    // myzset successfully decoded as key (string). Decoded value myzset. Tokens remaining [(1,+inf,BYSCORE,LIMIT,1,1], target args remainin count: 4
    // (1 successfully decoded as min (string). Decoded value (1. Tokens remaining [+inf,BYSCORE,LIMIT,1,1], target args remainin count: 3
    // +inf successfully decoded as max (string). Decoded value +inf. Tokens remaining [BYSCORE,LIMIT,1,1], target args remainin count: 2
    // BYSCORE successfully decoded as sortby (string). Decoded value BYSCORE. Tokens remaining [LIMIT,1,1], target args remainin count: 1
    ...
    // Target args remain but no tokens left! Target args [ { name: 'LIMIT_1_1', schema: { title: 'count', type: 'integer' } } ]
    // ---
    // decoding ZRANGE overload 12 (key,min,max,sortby,rev): { name: 'key', schema: { title: 'key', type: 'string' }, toString: [Function (anonymous)] },{ name: 'min', schema: { title: 'min', type: 'string' }, toString: [Function (anonymous)] },{ name: 'max', schema: { title: 'max', type: 'string' }, toString: [Function (anonymous)] },{ name: 'sortby', optional: true, schema: { title: 'sortby', type: 'string', enum: [ 'BYSCORE', 'BYLEX' ] }, toString: [Function (anonymous)] },{ name: 'rev', optional: true, schema: { title: 'rev', type: 'string', enum: [ 'REV' ] }, toString: [Function (anonymous)] }
    // myzset successfully decoded as key (string). Decoded value myzset. Tokens remaining [(1,+inf,BYSCORE,LIMIT,1,1], target args remainin count: 4
    // (1 successfully decoded as min (string). Decoded value (1. Tokens remaining [+inf,BYSCORE,LIMIT,1,1], target args remainin count: 3
    // +inf successfully decoded as max (string). Decoded value +inf. Tokens remaining [BYSCORE,LIMIT,1,1], target args remainin count: 2
    // BYSCORE successfully decoded as sortby (string). Decoded value BYSCORE. Tokens remaining [LIMIT,1,1], target args remainin count: 1
