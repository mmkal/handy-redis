...
test("scripts/redis-doc/commands/zrem.md example 1", async t => {
    const overrider = getOverride("scripts/redis-doc/commands/zrem.md");
    let snapshot: any;
    const commands = [
    ...
    try {
        ...
        output.push(await handy.zrem("myzset", "two"));
