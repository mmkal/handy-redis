...
test("scripts/redis-doc/commands/sinterstore.md example 1", async t => {
    const overrider = getOverride("scripts/redis-doc/commands/sinterstore.md");
    let snapshot: any;
    const commands = [
    ...
    try {
        ...
        output.push(await handy.sinterstore("key", "key1", "key2"));
