...
test("docs/redis-doc/commands/blmpop.md example 1", async () => {
    ...
    // decoding BLMPOP overload 0 (timeout,numkeys,where): { name: 'timeout', schema: { title: 'timeout', type: 'number' }, toString: [Function (anonymous)] },{ name: 'numkeys', schema: { title: 'numkeys', type: 'integer' }, toString: [Function (anonymous)] },{ name: 'where', schema: { title: 'where', type: 'string', enum: [ 'LEFT', 'RIGHT' ] }, toString: [Function (anonymous)] }
