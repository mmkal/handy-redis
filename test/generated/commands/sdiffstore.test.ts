...
it("scripts/redis-doc/commands/sdiffstore.md example 1", async () => {
    const overrider = getOverride("scripts/redis-doc/commands/sdiffstore.md");
    let snapshot: any;
    const commands = [
    ...
    try {
        ...
        output.push(await client.sdiffstore("key", "key1", "key2"));
